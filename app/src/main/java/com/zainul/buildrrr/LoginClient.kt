...
class LoginClient : Fragment(R.layout.activity_login_client) {

    private lateinit var auth: FirebaseAuth
    private lateinit var database: FirebaseDatabase
    private var _binding: ActivityLoginClientBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ActivityLoginClientBinding.inflate(inflater, container, false)
        return binding.root
