...
import com.zainul.buildrrr.mainmarketing.UploadActivity

class Loadingmarketing : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Handler().postDelayed({ //setelah loading maka akan langsung berpindah ke home activity
            val home = Intent(this@Loadingmarketing, UploadActivity::class.java)
            startActivity(home)
            finish()
