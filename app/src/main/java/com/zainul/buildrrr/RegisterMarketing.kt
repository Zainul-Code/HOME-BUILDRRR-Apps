...
import com.zainul.buildrrr.databinding.ActivityRegisterMarketingBinding
import com.zainul.buildrrr.loading.Loadingmarketing
import kotlinx.android.synthetic.main.activity_register_marketing.*

class RegisterMarketing : Fragment() {

    private lateinit var auth: FirebaseAuth
    private lateinit var database: FirebaseDatabase
    private var _binding: ActivityRegisterMarketingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ActivityRegisterMarketingBinding.inflate(inflater, container, false)
        return binding.root
                        ...
                        if (it.isSuccessful) {
                            ...
                            databaseRef.setValue(user).addOnCompleteListener{
                                if(it.isSuccessful){
                                    ...
                                    val intent = Intent(activity, Loadingmarketing::class.java)
